...
xst -ifn xst.scr
move clkup_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkup_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkup_exdes.ucf clkup_exdes

echo 'Running map'
map -timing -pr b clkup_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkup_exdes -w routed.ncd routed.vhd
cd ..
